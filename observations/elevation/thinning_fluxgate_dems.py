...
plt.xticks(np.arange(-120,120,40),fontsize=8)
plt.yticks(np.arange(-120,120,40),fontsize=8)
plt.ylim([-110,80])
plt.xlim([-110,80])
plt.ylabel('Flux dH/dt (m yr$^{-1}$)',fontsize=9)
plt.xlabel('DEM dH/dt (m yr$^{-1}$)',fontsize=9)
plt.tight_layout()
...
plt.errorbar(dem_time_H[:,0],dem_dH_H[:,0],xerr=dem_time_H[:,1],yerr=dem_dH_H[:,1],fmt='bo',markersize=2.5,capsize=1,lw=0.5,label='DEM')
#plt.errorbar(time_H_2,dH_H_2,label='Helheim',fmt='r.',markersize=4,capsize=1,lw=0.5)
plt.errorbar(time_H,dH_H[:,0]+smb_H,fmt='rs',markersize=2.5,capsize=1,lw=0.5,label='Flux-gate')
...
plt.ylabel(r'dH/dt (m yr${-1}$)',fontname='Arial',fontsize=9)
plt.yticks(np.arange(-160,160,40),fontsize=8,fontname='Arial')
plt.ylim([-155,120])
ax.set_xticklabels([])
...
for i in range(0,len(yH_runoff)):
  ...
  ax.add_patch(patch)
plt.text(time1+0.2,95,'a',fontsize=9,fontname='Arial',fontweight='bold')  
...
plt.plot(time_H[ind],Q_H[ind,0]/1e9,'b.',markersize=4,label = 'Inflow')
ind = np.where(~(np.isnan(Q_H[:,1])))[0]
plt.plot(time_H[ind],Q_H[ind,1]/1e9,'r.',markersize=4, label = 'Outflow')
...
for i in range(0,len(yH_runoff)):
  ...
  patch = matplotlib.patches.PathPatch(path,facecolor='0.85',edgecolor='none',lw=0)
  ax.add_patch(patch)
plt.text(time1+0.2,38,'d',fontsize=9,fontname='Arial',fontweight='bold')
...
plt.subplot(gs[2])
ax = plt.gca()
#plt.errorbar(vel_time_H,(vel_val_H[:,0]-vel_val_H[:,1])/((dists_eul[0]-dists_eul[1])*1e3),fmt='b.',label='5-7 km',markersize=4,capsize=1)
...
#plt.plot(vel_time_H,strain_H[:,0],'k.',markersize=4)
plt.plot(time_H,(ubar_H[:,1]-ubar_H[:,0])/(1e3),'k.',markersize=4)
...
for i in range(0,len(yH_runoff)):
  ...
  patch = matplotlib.patches.PathPatch(path,facecolor='0.85',edgecolor='none',lw=0)
  ax.add_patch(patch)
plt.text(time1+0.2,3.0,'b',fontsize=9,fontname='Arial',fontweight='bold')
...
#plt.errorbar(time_dem_H,(zpt_dem_H[:,2]-zpt_dem_H[:,1])/3.0e3,yerr=(2*zpterror_dem_H)/2.0e3,fmt='k.',label='Kanger',markersize=4,capsize=1)
#plt.plot(slope_H[:,0],slope_H[:,1],'r.',label='Helheim',markersize=4)
#plt.plot(time_H_zs,(hbar_H_zs[:,0]-hbar_H_zs[:,1])/(dists_H[indbox_H[-1]]-dists_H[indbox_H[0]]),'k.',markersize=4)
plt.plot(time_H_zs,(hbar_H_zs[:,0]-hbar_H_zs[:,1]),'k.',markersize=4)
...
plt.yticks(np.arange(0,40,5),fontsize=8,fontname='Arial')
plt.ylim([17,32])
#plt.ylim([17,32])
plt.xlim([time1,time2])
ax.set_xticklabels([])
for i in range(0,len(yH_runoff)):
  ...
  patch = matplotlib.patches.PathPatch(path,facecolor='0.85',edgecolor='none',lw=0)
  ax.add_patch(patch)
plt.text(time1+0.2,29.5,'c',fontsize=9,fontname='Arial',fontweight='bold')
ax.set_xticklabels([])
...
ax = plt.gca()
plt.plot([time1,time2],[0,0],'k')
plt.plot(timerac_K,smbrac_K*365.25/900.,'0.4',lw=1.2,label='SMB')
#plt.plot(timezsrac_K[1:],np.convolve(np.diff(zsrac_K)/np.diff(timezsrac_K),np.ones((11,))/11.,mode='same'),c='0.4',lw=1.2,label='SMB')
#plt.plot(time_K,smb_K,c='0.5',lw=0.75,label='SMB')
plt.errorbar(dem_time_K[:,0],dem_dH_K[:,0],xerr=dem_time_K[:,1],yerr=dem_dH_K[:,1],fmt='bo',markersize=2.5,capsize=1,lw=0.5,label='DEM')
#plt.errorbar(time_K_2,dH_K_2,label='Helheim',fmt='r.',markersize=4,capsize=1,lw=0.5)
plt.errorbar(time_K,dH_K[:,0]+smb_K,fmt='rs',markersize=2.5,capsize=1,lw=0.5,label='Flux')
...
plt.xlim([time1,time2])
plt.ylabel(r'dH/dt (m yr${-1}$)',fontname='Arial',fontsize=9)
plt.yticks(np.arange(-120,120,40),fontsize=8,fontname='Arial')
plt.ylim([-90,90])
ax.set_xticklabels([])
#xTickPos = np.linspace(np.floor(time1)-0.25,np.ceil(time2)-0.25,(np.ceil(time2)-np.floor(time1))*2+1)
#ax.bar(xTickPos, [max(plt.ylim())-min(plt.ylim())] * len(xTickPos), (xTickPos[1]-xTickPos[0]), bottom=min(plt.ylim()), color=['0.85','w'],linewidth=0)
for i in range(0,len(yH_runoff)):
  ...
  patch = matplotlib.patches.PathPatch(path,facecolor='0.85',edgecolor='none',lw=0)
  ax.add_patch(patch)
plt.text(time1+0.2,75,'a',fontsize=9,fontname='Arial',fontweight='bold')  
plt.legend(loc=1,numpoints=1,ncol=3,handletextpad=0.2,fontsize=8,columnspacing=0.05,markerscale=1,handlelength=1.2,borderpad=0.2)
...
plt.plot(time_K[ind],Q_K[ind,0]/1e9,'b.',markersize=4,label = 'Inflow')
ind = np.where(~(np.isnan(Q_K[:,1])))[0]
plt.plot(time_K[ind],Q_K[ind,1]/1e9,'r.',markersize=4, label = 'Outflow')
plt.ylabel('Ice flux \n'+r'(km$^{3}$ yr$^{-1}$)',fontsize=9,fontname='Arial')
plt.xticks(range(2008,2017))
plt.xlim([time1,time2])
...
for i in range(0,len(yH_runoff)):
  ...
  patch = matplotlib.patches.PathPatch(path,facecolor='0.85',edgecolor='none',lw=0)
  ax.add_patch(patch)
plt.text(time1+0.2,34.5,'d',fontsize=9,fontname='Arial',fontweight='bold')
plt.legend(loc=1,numpoints=1,ncol=3,handletextpad=0.2,fontsize=8,columnspacing=0.4,handlelength=0.3,borderpad=0.2)
labels=[]
for i in range(2000,2017):
  labels.append('Jan \n'+str(i))
...
plt.subplot(gs[2])
ax = plt.gca()
#plt.errorbar(vel_time_K,(vel_val_K[:,0]-vel_val_K[:,1])/((dists_eul[0]-dists_eul[1])*1e3),fmt='r.',label='5-7 km',markersize=4,capsize=1)
#plt.errorbar(vel_time_K,(vel_val_K[:,1]-vel_val_K[:,2])/((dists_eul[1]-dists_eul[2])*1e3),fmt='r.',label='Helheim',markersize=4,capsize=1)
#plt.errorbar(vel_time_K,(vel_val_K[:,2]-vel_val_K[:,3])/((dists_eul[2]-dists_eul[3])*1e3),fmt='g.',label='Helheim',markersize=4,capsize=1)
#plt.plot(vel_time_K,strain_K[:,0],'k.',markersize=4,label='Flux box')
plt.plot(time_K,(ubar_K[:,1]-ubar_K[:,0])/1e3,'k.',markersize=4)
plt.ylabel(r'$\bar{u}_{o}-\bar{u}_{i}$'+'\n'+r'(km yr$^{-1}$)',fontsize=9,fontname='Arial')
plt.yticks(np.arange(0,4,0.1),fontsize=8,fontname='Arial')
#plt.ylim([0.1,0.6])
plt.ylim([0.52,0.88])
plt.xticks(range(2008,2017))
plt.xlim([time1,time2])
...
for i in range(0,len(yH_runoff)):
  ...
  patch = matplotlib.patches.PathPatch(path,facecolor='0.85',edgecolor='none',lw=0)
  ax.add_patch(patch)
plt.text(time1+0.2,0.8,'b',fontsize=9,fontname='Arial',fontweight='bold')
#plt.legend(loc=1,numpoints=1,ncol=2,handletextpad=0.1,fontsize=8,columnspacing=0.05,handlelength=1)

plt.subplot(gs[3])
ax = plt.gca()
#plt.errorbar(time_atm_K,(zpt_atm_K[:,1]-zpt_atm_K[:,0])/2.0e3,fmt='k.',label='Kanger',markersize=3,capsize=1)
#plt.errorbar(time_dem_K,(zpt_dem_K[:,1]-zpt_dem_K[:,0])/2.0e3,yerr=(2*zpterror_dem_K)/2.0e3,fmt='k.',label='Kanger',markersize=4,capsize=1)
#plt.plot(slope_K[:,0],slope_K[:,1],'k.',label='Helheim',markersize=4)
#plt.plot(time_K_zs,(hbar_K_zs[:,0]-hbar_K_zs[:,1])/(dists_K[indbox_K[-1]]-dists_K[indbox_K[0]]),'k.',markersize=4)
plt.plot(time_K_zs,(hbar_K_zs[:,0]-hbar_K_zs[:,1]),'k.',markersize=4)
plt.ylabel(r'$\bar{H}_{i}-\bar{H}_{o}$'+'\n (m)',fontsize=9,fontname='Arial')
plt.xticks(range(2008,2017))
#plt.yticks(np.arange(0,1,0.001),fontsize=8,fontname='Arial')
#plt.ylim([0.0185,0.0235])
plt.yticks(np.arange(60,80,5),fontsize=8,fontname='Arial')
plt.ylim([64,76])
plt.xlim([time1,time2])
ax.set_xticklabels([])
for i in range(0,len(yH_runoff)):
  ...
  patch = matplotlib.patches.PathPatch(path,facecolor='0.85',edgecolor='none',lw=0)
  ax.add_patch(patch)
plt.text(time1+0.2,74,'c',fontsize=9,fontname='Arial',fontweight='bold')
ax.set_xticklabels([])
