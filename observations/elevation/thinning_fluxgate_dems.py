...
plt.errorbar(dem_time_H[:,0],dem_dH_H[:,0],xerr=dem_time_H[:,1],yerr=dem_dH_H[:,1],fmt='bo',markersize=3,capsize=1,lw=0.5,label='DEM')
#plt.errorbar(time_H_2,dH_H_2,label='Helheim',fmt='r.',markersize=4,capsize=1,lw=0.5)
plt.errorbar(time_H,dH_H[:,0]+smb_H,fmt='rs',markersize=3,capsize=1,lw=0.5,label='Flux-gate')
...
plt.plot(time_H,(ubar_H[:,1]-ubar_H[:,0])/(1e3),'k.',markersize=5)
...
plt.plot(time_H_zs,(hbar_H_zs[:,0]-hbar_H_zs[:,1]),'k.',markersize=5)
...
plt.errorbar(dem_time_K[:,0],dem_dH_K[:,0],xerr=dem_time_K[:,1],yerr=dem_dH_K[:,1],fmt='bo',markersize=3,capsize=1,lw=0.5,label='DEM')
#plt.errorbar(time_K_2,dH_K_2,label='Helheim',fmt='r.',markersize=4,capsize=1,lw=0.5)
plt.errorbar(time_K,dH_K[:,0]+smb_K,fmt='rs',markersize=3,capsize=1,lw=0.5,label='Flux')
...
plt.plot(time_K,(ubar_K[:,1]-ubar_K[:,0])/1e3,'k.',markersize=5)
plt.ylabel(r'$\bar{u}_{o}-\bar{u}_{i}$'+'\n'+r'(km yr$^{-1}$)',fontsize=9,fontname='Arial')
...
plt.plot(time_K_zs,(hbar_K_zs[:,0]-hbar_K_zs[:,1]),'k.',markersize=5)
plt.ylabel(r'$\bar{H}_{i}-\bar{H}_{o}$'+'\n (m)',fontsize=9,fontname='Arial')
plt.xticks(range(2008,2017))
