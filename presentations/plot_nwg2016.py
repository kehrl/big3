# Make some plots for my NWG 2016 presentation
...
ax.axis('off')
plt.tight_layout()
plt.savefig(os.path.join(os.getenv("HOME"),"Bigtmp/NWG_overviewmap.pdf"),format='PDF',transparent=True,dpi=600)
plt.close()
...
plt.savefig(os.path.join(os.getenv("HOME"),"Bigtmp/NWG_Helheim_map.pdf"),FORMAT='PDF',dpi=600,transparent=True)
...
plt.savefig(os.path.join(os.getenv("HOME"),"Bigtmp/NWG_Helheim_map1.pdf"),FORMAT='PDF',dpi=600,transparent=True)
plt.close()
...
plt.savefig(os.path.join(os.getenv("HOME"),"Bigtmp/NWG_Helheim_2000.pdf"),format="PDF")
plt.close()
...
for glacier in ['Helheim']:
  ...
  plt.savefig(os.path.join(os.getenv("HOME"),'Bigtmp/NWG_'+glacier+'_zs_flowline.pdf'),FORMAT='PDF',dpi=600)
  plt.close()
...
for glacier in ['Helheim','Kanger']:
  ...
  for k in range(0,5+len(demtimes)):
    ...
    plt.savefig(os.path.join(os.getenv("HOME"),"Bigtmp/NWG_"+glacier+"_all"+str(k)+".pdf"),FORMAT='PDF',dpi=600)
    plt.close()
  ...
  for k in range(0,len(demtimes)):
    ...
    plt.savefig(os.path.join(os.getenv("HOME"),"Bigtmp/NWG_"+glacier+"_dem"+str(k)+".pdf"),FORMAT='PDF',dpi=600)
    plt.close()
  ...
  for k in range(0,len(demtimes)):   
    ...
    plt.savefig(os.path.join(os.getenv("HOME"),"Bigtmp/NWG_"+glacier+"_image"+str(k)+".pdf"),FORMAT='PDF',dpi=600,transparent=True)
    plt.close()
...
for glacier in ['Helheim','Kanger']:
  ...
  for k in range(0,2):
    ...
    plt.savefig(os.path.join(os.getenv("HOME"),"Bigtmp/NWG_"+glacier+"_icefront"+str(k)+".pdf"),FORMAT='PDF',dpi=600)
    plt.close()
...
for i in range(0,2):
  ...
  plt.savefig(os.path.join(os.getenv("HOME"),"Bigtmp/NWG_Helheim_unground"+str(i)+".pdf"),FORMAT='PDF',dpi=600,transparent=True)
  plt.close()
