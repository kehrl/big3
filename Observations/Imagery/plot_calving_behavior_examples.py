...
plt.xticks([])
plt.yticks([])
plt.text(xmin+0.05*(xmax-xmin),ymax-0.12*(ymax-ymin),'a',fontsize=12,fontname='arial',fontweight='bold')
...
plt.xticks([])
plt.yticks([])
plt.text(xmin+0.05*(xmax-xmin),ymax-0.12*(ymax-ymin),'b',fontsize=12,fontname='arial',fontweight='bold')
...
ax.text(xmin+0.62*(xmax-xmin)+1e3,ymin+0.89*(ymax-ymin),'1 km',fontsize=12)
