...
import glacier_flowline, elevation, icefronts
import numpy as np
...
float = glacier_flowline.flotation_height(zb,rho_i=917.0,rho_sw=1020.0)
...
# Save figure
plt.savefig(os.path.join(os.getenv("HOME"),'Bigtmp/'+glacier+'_zs_time.pdf'),FORMAT='PDF')
plt.close()