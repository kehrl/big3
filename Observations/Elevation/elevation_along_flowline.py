...
if plot_overview:
  ...
  if glacier == 'Helheim':
    plt.ylim([0,670])
    plt.text(-19.5,500,'b',fontsize=11,fontweight='bold')
  elif glacier == 'Kanger':
    plt.ylim([0,800])
    plt.text(-19.5,560,'b',fontsize=11,fontweight='bold')
  ...
  if glacier == 'Helheim':
    ...
    plt.text(-3,-1050,'??',fontsize=10,fontname='arial')
    plt.text(3.2,-500,'??',fontsize=10,fontname='arial')
  #plt.plot(dists/1e3,zb+50,'k--',lw=0.75)
  #plt.plot(dists/1e3,zb-50,'k--',lw=0.75)
  plt.xlabel('Distance from mean terminus (km)',fontsize=10)
  plt.xticks(np.arange(-30,10,5),fontsize=10)
  plt.xlim([-21,6])
  plt.text(-19.5,-500,'c',fontsize=11,fontweight='bold')
...
if plot_time:
  ...
  plt.xlim([2001,2016])
  plt.xticks(np.arange(2001,2016,2),fontsize=10)
  plt.yticks(np.arange(0,1000,100),fontsize=10)
  plt.ylim([0,800])
  plt.ylabel('Elevation (m asl)',fontsize=10)
  plt.legend(loc=2,labelspacing=0.3,numpoints=1,fontsize=10)
  pos = ax.get_position() 
