...
def dem_continuous(glacier,xmin,xmax,ymin,ymax,date,verticaldatum='geoid',blur=False,dx='none'):
  ...
  if glacier == 'Helheim':
    if date == '20040803':
      ...
      dates = ['20140509','20140611','20140418','20130508']
    elif date == '20140731':
      dates = ['20140731','20130804']
    else:
      dates = np.array([date])
    ...
    if date == '20010712':
      ...
      dates = ['20110308','20110311','20110318','20110708']
    elif date == '20110712':
      dates = ['20110712','20110808','20110823']
    elif date == '20110826':
      dates = ['20110826','20110824']
    elif date == '20150808':
      dates = ['20150808','20150814','20150818','20150801','20150802']  
    else:
      dates = np.array([date])
