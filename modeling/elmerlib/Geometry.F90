!This moduled, loosely named 'geometry' is for basically any reusable routines which I happen to develop.
!Author: Joe Todd 
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  !Function to rotate a given mesh (or point?) by 
  !a given angle.  Returns the rotated mesh (or point)
  !perhaps there should be a function for the mesh, 
  !which calls a separate function for each point pair.
  !
  !Look at rigid mesh mapper for help here
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  !! Convex Hull
  !! Downloaded from http://jblevins.org/mirror/amiller/envelope.f90
  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
60  IF (i /= i2save) THEN
  ...
  !! Downloaded from http://jblevins.org/mirror/amiller/locpt.f90
  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  SUBROUTINE locpt (x0, y0, x, y, n, l, m)
    ...
    IMPLICIT NONE
    REAL(KIND=dp), INTENT(IN)     :: x0, y0, x(:), y(:)
    INTEGER, INTENT(IN)  :: n
