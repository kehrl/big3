...
! ******************************************************************************
! *
! *  Authors: Joe Todd, modified by Laura Kehrl
! *  Email:
...
!A routine for getting frontal advance in 3D, given velocity
...
!-----------------------------------------------
   ...
   REAL(KIND=dp) :: FrontOrientation(3),RotationMatrix(3,3),&
        NodeVelo(3), NodeNormal(3), ColumnNormal(3), CornerDirection(2),&
        Displace(3), NodeHolder(3), DangerGrad, ShiftTo, direction, &
   ...
   LOGICAL :: Found, Debug, Parallel, Boss, ShiftLeft, LeftToRight, MovedOne, ShiftSecond, &
        Protrusion, SqueezeLeft, SqueezeRight, FirstTime=.TRUE., intersect_flag
