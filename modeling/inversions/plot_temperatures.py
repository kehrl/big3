...
for i in range(0,nt):
    ...
    ax.text(xmin+0.03*(xmax-xmin),ymin+0.92*(ymax-ymin),'(a) FS-CT',fontweight='bold',fontsize=12)
    ...
    cb.ax.tick_params(labelsize=10)
    ax.text(xmin+0.03*(xmax-xmin),ymin+0.92*(ymax-ymin),'(b) FS-MT',fontweight='bold',fontsize=12)
    ...
    ax.text(xmin+0.68*(xmax-xmin),ymin+0.79*(ymax-ymin),r'$\tau_b$ (kPa)',fontsize=10)
    cb.ax.tick_params(labelsize=10)
    ax.text(xmin+0.03*(xmax-xmin),ymin+0.92*(ymax-ymin),'(c) SSA-CT',fontweight='bold',fontsize=12)
    ...
    ax.text(xmin+0.68*(xmax-xmin),ymin+0.79*(ymax-ymin),r'$\tau_b$ (kPa)',fontsize=10)
    cb.ax.tick_params(labelsize=10)
    ax.text(xmin+0.03*(xmax-xmin),ymin+0.92*(ymax-ymin),'(d) SSA-MT',fontweight='bold',fontsize=12)
...
for i in range(0,nt):
    ...
    if glacier == 'Kanger':
        ...
        ax.text(xmin+0.65*(xmax-xmin),ymin+(0.725+topd*2)*(ymax-ymin),r'$u_b/u$',fontsize=8)
        cb.ax.tick_params(labelsize=8)
