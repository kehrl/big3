...
# Beds
VEL=$HOME/Dropbox/Code/Solver_files/3D/Helheim/Inputs/VMAG.xy
...
xyz2grd taub_1e10.dat -Gtaub.grd $R -I200 -NNaN
...
makecpt -Cdrywet -T10/10000/3 -Z -Qo > velscale.cpt

psbasemap $J $R $B -P -K -V > $FILE
grdimage $IMAGE -Cgray $J $R $B -K -O -V >> $FILE
grdimage vel2.grd -Cvelscale.cpt $J $R $B -K -Q -O -V >> $FILE
...
#Scale bars
psscale -D3.04i/2.85i/1i/0.15ih -Cvelscale.cpt -B0::/:: -Qo -O -K -V >> $FILE
...
#230000 -2520000 12 1 1 TL b
295000  -2518000 12 0 0 TL Velocity
229000  -2589000 11 0 0 TL 0
239000  -2589000 11 0 0 TL 10
249000  -2589000 11 0 0 TL 20 km
297000  -2528000 12 0 0 TL 0.1
306800  -2528000 12 0 0 TL 1
312000  -2528000 12 0 0 TL 10
298000  -2532000 12 0 0 TL km/yr
#290000  -2528000 12 0 0 TL 0
#305073.776937 -2578289.20561 9 0 0 TL 0 km
#289749.968209 -2566725.38141 9 0 0 TL 20 km
END

ps2raster -Tf vel_polar.ps